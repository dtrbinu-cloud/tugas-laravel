<nav x-data="{ open: false }" class="sticky top-0 z-30 border-b border-slate-200/80 bg-white/85 backdrop-blur">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold leading-4 text-slate-700 transition hover:border-sky-200 hover:text-sky-600 focus:outline-none">
